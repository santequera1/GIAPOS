...
const API_KEY = process.env.WHATSAPP_AI_API_KEY || 'gia_ai_bot_2026_cartagena';
...
router.get('/sales/summary', (req, res) => {
  ...
  let whatsappText = `📊 *REPORTE DE VENTAS — GIA GELATERÍA*\n`;
...
router.get('/products', (req, res) => {
  ...
  let whatsappText = `🍨 *CATÁLOGO GIA GELATERÍA* (${products.length} productos):\n\n`;
...
router.get('/orders/recent', (req, res) => {
  ...
  orders.forEach(o => {
    ...
    whatsappText += `• *GIA-${o.id}* — ${formatCOP(o.total)} [${pay}]\n`;
