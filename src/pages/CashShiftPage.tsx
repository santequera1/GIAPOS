...
export const CashShiftPage: React.FC = () => {
  ...
  const handleOpenNewShift = async () => {
    ...
    try {
      await openShift(base, cashierNameInput || 'Cajero Convención', 'Apertura de turno');
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-[#897863]">
              Control de efectivo, datáfonos y ventas de la convención
            </p>
          </div>
        </div>
              ...
              <div className="space-y-3 text-xs">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Ej. Cajero Convención"
