...
export const useStore = create<AppState>((set, get) => ({
  ...
  deliveryFee: 5000,
  tableCount: 8,
  businessName: 'Gia Gelatería',
  businessSlogan: 'Auténtico Gelato artesanal',
  initialized: false,
  ...
  initialize: async () => {
    try {
      ...
      set({
        ...
        businessName: settings.businessName || 'Gia Gelatería',
        businessSlogan: settings.businessSlogan || 'Auténtico Gelato artesanal',
        initialized: true,
      });
    } catch (err) {
